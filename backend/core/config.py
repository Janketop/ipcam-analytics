...
class Settings(BaseSettings):
    ...
    face_training_run_name: str = Field("yolov11m-widerface")
    face_training_base_weights: str = Field("yolo11m.pt")
    face_training_output_weights: str = Field("backend/weights/yolov11m-face.pt")
