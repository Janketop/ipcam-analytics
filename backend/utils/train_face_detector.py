"""Обучение детектора лиц на основе YOLOv11n и датасета WIDERFace.
...
`backend/weights/yolov11n-face.pt`, а логи обучения — в каталоге
`runs/face/yolov11n-widerface`.
"""
...
DEFAULT_OUTPUT_WEIGHTS = Path("backend/weights/yolov11n-face.pt")
DEFAULT_PROJECT_DIR = Path("runs/face")
DEFAULT_RUN_NAME = "yolov11n-widerface"
